...
public class UsersFragment extends Fragment {
    ...
    com.example.socialize.AdapterUsers adapterUsers;
    List<com.example.socialize.ModelUsers> usersList;
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()) {
                    com.example.socialize.ModelUsers modelUsers = dataSnapshot1.getValue(com.example.socialize.ModelUsers.class);
                    ...
                    if (dataSnapshot1.exists()) {
                        ...
                        adapterUsers = new com.example.socialize.AdapterUsers(getActivity(), usersList);
