...
public class AddBlogsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //image2 = view.findViewById(R.id.imagep2);
    ...
    private void uploadData(final String titl, final String description) {
        ...
        String filepathname=  "Posts/" + "post" +timestamp;
            ...
            /*pd.setMessage("Before the method");
            pd.show(); */
            ...
            databaseReference.child(timestamp).setValue(hashMap)
                    .addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            //imageuri=null;
                            startActivity(new Intent(getContext(), com.example.socialize.DashboardActivity.class));
                            getActivity().finish();
                        }
            ...
            storageReference1.putBytes(data).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    /*pd.setMessage("After the onSucess method");
                    pd.show(); */
                    Task<Uri> uriTask=taskSnapshot.getStorage().getDownloadUrl();
                    ...
                    if(uriTask.isSuccessful()){
                        ...
                        if(downloadUri.isEmpty() || downloadUri==null ){
                            hashMap.put("uimage","");
                        }else{
                            hashMap.put("uimage",downloadUri);
                        }
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    /*pd.setMessage("Failure the method");
                    pd.show();*/
                    pd.dismiss();
                    Toast.makeText(getContext(),"Failed 2"+e,Toast.LENGTH_LONG).show();
                }
            });
