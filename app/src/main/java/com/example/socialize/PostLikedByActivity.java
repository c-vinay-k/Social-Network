...
public class PostLikedByActivity extends AppCompatActivity {
    ...
    String postId;
    List<com.example.socialize.ModelUsers> list;
        ...
        databaseReference.orderByChild("uid").equalTo(hisUid).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot ds:dataSnapshot.getChildren()){
                    com.example.socialize.ModelUsers model=ds.getValue(com.example.socialize.ModelUsers.class);
                    list.add(model);
                }
                adapterUsers=new com.example.socialize.AdapterUsers(PostLikedByActivity.this,list);
