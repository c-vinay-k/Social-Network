...
public class AdapterUsers extends RecyclerView.Adapter<AdapterUsers.MyHolder> {
    ...
    public AdapterUsers(Context context, List<com.example.socialize.ModelUsers> list) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, final int position) {
        ...
        try {
            if(userImage.isEmpty()){
                Glide.with(context).load(R.drawable.profile_image).into(holder.profiletv);
            }else {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent=new Intent(context, UnknownUserProfile.class);
                intent.putExtra("uid",hisuid);
                context.startActivity(intent);
            }
        });
