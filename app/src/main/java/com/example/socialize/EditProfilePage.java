...
public class EditProfilePage extends AppCompatActivity {
    ...
    String uid;
    ImageView set;
    TextView profilepic,editname,editpassword,changebio;
    ProgressDialog pd;
    ...
    private void showBioUpdate(final String key){
        AlertDialog.Builder builder=new AlertDialog.Builder(this);
                    ...
                    query.addValueEventListener(new ValueEventListener() {
                        ...
                        public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                            ...
                            for(DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                                ...
                                dataSnapshot1.getRef().child("ubio").setValue(value);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if(resultCode == Activity.RESULT_OK){
            if(requestCode==IMAGEPICK_GALLERY_REQUEST){
                if(data==null){
                    Toast.makeText(EditProfilePage.this,"Data is NULL",Toast.LENGTH_LONG).show();
                }else{
