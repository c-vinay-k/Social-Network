...
public class AdapterComment extends RecyclerView.Adapter<AdapterComment.MyHolder>{
    ...
    Context context;
    List<com.example.socialize.ModelComment> list;

    public AdapterComment(Context context, List<com.example.socialize.ModelComment> list, String myuid, String postid) {
    ...
    public void onBindViewHolder(@NonNull MyHolder holder, int position) {
        ...
        try {
            if(image.isEmpty()){
                Glide.with(context).load(R.drawable.profile_image).into(holder.imagea);
            }else{
