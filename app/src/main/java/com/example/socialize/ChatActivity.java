...
public class ChatActivity extends AppCompatActivity {
    ...
    List<com.example.socialize.ModelChat> chatList;
    com.example.socialize.AdapterChat adapterChat;
    ...
    private void readMessages() {
        ...
        dbref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                chatList.clear();
                for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                    com.example.socialize.ModelChat modelChat=dataSnapshot1.getValue(com.example.socialize.ModelChat.class);
                    ...
                    adapterChat=new com.example.socialize.AdapterChat(ChatActivity.this,chatList,image);
