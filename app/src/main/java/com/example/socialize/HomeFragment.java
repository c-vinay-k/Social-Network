...
List<com.example.socialize.ModelPost> posts;
    com.example.socialize.AdapterPosts adapterPosts;
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               for (DataSnapshot dataSnapshot1:dataSnapshot.getChildren()){
                 ...
                 posts.add(modelPost);
                   adapterPosts=new com.example.socialize.AdapterPosts(getActivity(),posts);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(item.getItemId()==R.id.logout){
            ...
            startActivity(new Intent(getContext(), com.example.socialize.SplashScreen.class));
            getActivity().finish();
        }
